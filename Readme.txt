...
Por último, los recorridos poseen una complejidad de O(N) debido a que si importar el orden recorrera todos y cada uno de los nodos pertenecientes al arbol.
